#define scrObjMediumBasicShipCreate
...
#define scrObjMediumBasicShipStep
if(!global.isGamePaused) //only execute when not paused
{
    ...
    else
    {
        ...
        if(abs(diffAngle) < 10)
        {
            ...
            {
                //Fire weapon
                var bullet = instance_create(x,y, objProjectilePhotonTorpedo1);
        ...
        {
            physics_apply_local_force(0,0, -9, 0);
        }
    } 
